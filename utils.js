...
// The worker logic is stored as a string to be created as a Blob URL.
// IMPORTANT: All functions used by the worker (like clamp, dot, etc.) must be INCLUDED IN THIS STRING
// as the worker runs in an isolated scope.
